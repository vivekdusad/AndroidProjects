...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    EglBase rootEglBase;
    final int ALL_PERMISSION_CODE =1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED
            ...
            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.CAMERA, Manifest.permission.RECORD_AUDIO},ALL_PERMISSION_CODE);
        } else {
    ...
    public void onCreatedRoom() {
        showToast("You created the room " + getUserMedia);
        if (getUserMedia) {
    ...
    public void onJoinedRoom() {
        showToast("You joined the room " + getUserMedia);
        if (getUserMedia) {
            SignallingClient.getInstance().emitMessage("got user media");
        }
    }
    ...
    private void updateVideoViews(final boolean remoteVisible) {
        runOnUiThread(() -> {
            ...
            if (remoteVisible) {
                ((ViewGroup.LayoutParams) params).height = dpToPx(100);
