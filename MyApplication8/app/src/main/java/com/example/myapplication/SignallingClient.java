...
public class SignallingClient {
    ...
    public  void init(SignalingInterface signalingInterface){
        ...
        try{
            ...
            socket = IO.socket("https://192.168.43.103");
            socket.connect();
            Log.d("Signalling Clinet","init() called");
            if(!roomName.isEmpty()){
                emitInitStatment(roomName);
            }
            //room created event.
    ...
    public void emitInitStatment(String roomName) {
        Log.d("SignallingClient", "emitInitStatement() called with: event = [" + "create or join" + "], message = [" + roomName + "]");
    ...
    public void emitIceCandidate(IceCandidate iceCandidate){
        try{
            ...
            object.put("type","canndidate");
            object.put("id",iceCandidate.sdpMLineIndex);
